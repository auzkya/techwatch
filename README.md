...
Spuštění seeder specializací
php artisan db:seed --class=SpecSeeder

Spuštění serveru pro realtime notifikace:
php artisan reverb:start // odesílání notifikací
php artisan queue:work // zpracovávání požadavků ve frontě serveru (přijímání notifikací)
