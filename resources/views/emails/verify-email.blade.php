        ...
        <tr>
            <td text-align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border:0;margin:30px auto;padding:20px;background-color:#0F0F0F;">
                    ...
                    <tr>
                        <td>
                            <h2 style="margin:0 0 20px 0;">Děkujeme za registraci!</h2>
                            <p style="margin:0 0 20px 0;line-height:1.8;font-weight:400;">
                                Pro dokončení registrace klikněte na tlačítko níže.<br>
                                Tlačítko má platnost 1 hodinu. Po vypršení platnosti se budete muset znovu registrovat.
                            </p>
                            ...
                            <p style="margin-top:100px;font-size:12px;opacity:0.8;">
                                Pokud jste se na <a href="https://techwatch.cz" style="color:#F1F1F1;font-weight:600;text-decoration:none;">TechWatch</a> nezaregistroval(a), tuto zprávu ignorujte.
                            </p>
                        </td>
                    </tr>
                </table>
